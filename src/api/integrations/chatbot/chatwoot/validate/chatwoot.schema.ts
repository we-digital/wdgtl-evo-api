...
export const chatwootSchema: JSONSchema7 = {
  ...
  properties: {
    ...
    webhookSecret: { type: 'string', minLength: 24, maxLength: 255 },
    webhookPreviousSecret: { type: 'string', minLength: 24, maxLength: 255 },
    webhookPreviousSecretValidUntil: { type: 'string', format: 'date-time' },
  },
