...
export type Chatwoot = {
  ...
  OUTBOUND_MAX_OLDEST_AGE_MS: number;
  OUTBOUND_ADMISSION_MAX_WAIT_MS: number;
  OUTBOUND_ADMISSION_TIMEOUT_MS: number;
  OUTBOUND_TRANSPORT_CONCURRENCY: number;
  OUTBOUND_MAINTENANCE_CONCURRENCY: number;
  BOT_CONTACT: boolean;
  IMPORT: {
    DATABASE: {
      CONNECTION: {
  ...
  private envProcess(): Env {
    return {
      ...
      CHATWOOT: {
        ...
        OUTBOUND_MAX_BACKLOG: Number.parseInt(process.env.CHATWOOT_OUTBOUND_MAX_BACKLOG) || 10_000,
        OUTBOUND_MAX_OLDEST_AGE_MS: Number.parseInt(process.env.CHATWOOT_OUTBOUND_MAX_OLDEST_AGE_MS) || 3_600_000,
        OUTBOUND_ADMISSION_MAX_WAIT_MS: Number.parseInt(process.env.CHATWOOT_OUTBOUND_ADMISSION_MAX_WAIT_MS) || 2_000,
        OUTBOUND_ADMISSION_TIMEOUT_MS: Number.parseInt(process.env.CHATWOOT_OUTBOUND_ADMISSION_TIMEOUT_MS) || 5_000,
        OUTBOUND_TRANSPORT_CONCURRENCY: Number.parseInt(process.env.CHATWOOT_OUTBOUND_TRANSPORT_CONCURRENCY) || 4,
        OUTBOUND_MAINTENANCE_CONCURRENCY: Number.parseInt(process.env.CHATWOOT_OUTBOUND_MAINTENANCE_CONCURRENCY) || 2,
